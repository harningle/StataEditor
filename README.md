...
1. Sublime Text 3 *only*: install [Pywin32](https://github.com/SublimeText/Pywin32), also via Package Control. On Sublime Text 4, Package Control installs the `pywin32` library automatically, so we don't need to do anything. Restart Sublime Text once after installing StataEditor
